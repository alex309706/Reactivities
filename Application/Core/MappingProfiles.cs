    ...
    public class MappingProfiles:Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<ActivityAttendee, AttendeeDto>()
                ...
                .ForMember(d => d.FollowersCount, opt => 
                    opt.MapFrom(s => s.AppUser.Followers.Count))
                .ForMember(d => d.FollowingCount, opt => 
                    opt.MapFrom(s => s.AppUser.Followings.Count))
                .ForMember(d => d.Following, opt => 
                    opt.MapFrom(s => s.AppUser.Followers.Any(x=> x.Observer.UserName == currentUsername)));
            ...
            CreateMap<AppUser, Profiles.Profile>()
                ...
                .ForMember(d => d.Following, opt => 
                    opt.MapFrom(s => s.Followers.Any(x=> x.Observer.UserName == currentUsername)));
